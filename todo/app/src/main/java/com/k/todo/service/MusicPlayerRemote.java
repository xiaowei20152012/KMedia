...
public class MusicPlayerRemote {
    public static MusicPlayService musicService;
    ...
    public static ServiceToken bindToService(@NonNull final Context context,
        ...
        if (contextWrapper.bindService(new Intent().setClass(contextWrapper, MusicPlayService.class), binder, Context.BIND_AUTO_CREATE)) {
